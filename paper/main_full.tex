...
\item a matched external trace extension showing substantial scaffold differences in turns and tool calls at fixed task and model, and showing that the popular ``expensive failure'' premium dissolves under exact task matching; and
